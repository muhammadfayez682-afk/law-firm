...
export const NOTIFICATION_META: Record<NotificationType, NotificationMeta> = {
  ...
  verdict_recorded: { label: "تسجيل صك حكم", description: "سُجّل صك حكم على القضية", icon: "⚖️", category: "case", defaultPriority: "high" },
  finality_suggested: { label: "الحكم مرشّح للقطعية", description: "فاتت مهلة الاستئناف — الحكم مرشّح لاكتساب القطعية", icon: "⏳", category: "case", defaultPriority: "high" },
  finality_confirmed: { label: "اكتساب القطعية", description: "تأكّد اكتساب الحكم القطعية", icon: "🔏", category: "case", defaultPriority: "normal" },
  case_closed: { label: "إغلاق قضية", description: "أُغلقت القضية", icon: "🔒", category: "case", defaultPriority: "normal" },
